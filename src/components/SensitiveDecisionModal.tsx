...
export const SensitiveDecisionModal: React.FC<SensitiveDecisionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#070F1E]/85 backdrop-blur-md">
      <div className="bg-[#0E1E38] border-2 border-[#FF7032] rounded-2xl max-w-2xl w-full p-6 space-y-6 shadow-2xl shadow-[#FF7032]/20 animate-in fade-in zoom-in duration-200">
        ...
        {isAmbiguous && bids.length >= 2 && (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Option A */}
              <div className="bg-[#142848] p-4 rounded-xl border border-[#2F6690]/60 space-y-3 hover:border-[#8DC2FF] transition-all">
                ...
                <div className="text-xs space-y-1 font-mono text-[#CBD5E1] border-t border-white/5 pt-2">
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-lg bg-[#2F6690] hover:bg-[#3D7BAA] font-mono text-xs font-bold text-white flex items-center justify-center gap-1.5 transition-all shadow-md cursor-pointer"
                >
              ...
              {/* Option B */}
              <div className="bg-[#142848] p-4 rounded-xl border border-[#8DC2FF]/40 space-y-3 hover:border-[#8DC2FF] transition-all">
                <div className="flex justify-between items-start">
                  <div>
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded bg-[#1A335C] text-[#8DC2FF] font-mono font-bold">
                    Option B
                  </span>
                </div>
        ...
        {isHighValue && !isAmbiguous && (
          <div className="space-y-4 font-mono text-xs">
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[#142848] p-3 rounded-xl border border-white/5 opacity-60">
                <span className="text-[10px] text-[#CBD5E1] block">Standard Path (&lt; $1,000)</span>
                <span className="text-white font-bold">Optimistic Window</span>
              </div>
              <div className="bg-[#1A335C] p-3 rounded-xl border border-[#CEF26D]/50">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-[#2F6690] hover:bg-[#3D7BAA] font-mono text-xs font-bold text-white flex items-center justify-center gap-2 shadow-lg shadow-[#2F6690]/30 transition-all cursor-pointer"
            >
        ...
        {/* Footer */}
        <div className="flex items-center justify-between border-t border-white/10 pt-3 text-[11px] font-mono text-[#CBD5E1]">
          <button
            type="button"
            onClick={onCancel}
            className="flex items-center gap-1.5 text-[#CBD5E1] hover:text-white transition-all cursor-pointer"
          >
