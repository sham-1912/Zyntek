...
export const WhySolverWonCard: React.FC<WhySolverWonCardProps> = ({
  ...
  return (
    <div className="bg-[#0E1E38] border border-[#CEF26D]/50 rounded-2xl p-5 space-y-4 shadow-xl">
      ...
      <div className="flex items-center justify-between cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
        ...
        <button
          type="button"
          className="px-3 py-1.5 rounded-lg bg-[#142848] text-xs font-mono text-[#8DC2FF] flex items-center gap-1 hover:bg-[#1A335C] transition-all cursor-pointer"
        >
      ...
      {isOpen && (
        <div className="space-y-4 pt-2 border-t border-white/10 text-xs font-mono animate-in fade-in duration-200">
          ...
          <div className="bg-[#142848] p-3.5 rounded-xl border border-white/5 space-y-2">
            <div className="flex items-center justify-between text-[#8DC2FF] font-bold text-[11px]">
              ...
              <span className="text-[#CBD5E1]">Auto-Balanced to 100%</span>
            </div>

            <div className="grid grid-cols-3 gap-2 text-center text-xs">
              <div className="bg-[#0E1E38] p-2 rounded-lg border border-white/5">
                <span className="text-[10px] text-[#CBD5E1] block">Cost Weight</span>
                <span className="text-[#CEF26D] font-bold">{sliders.cost}%</span>
              </div>
              <div className="bg-[#0E1E38] p-2 rounded-lg border border-white/5">
                <span className="text-[10px] text-[#CBD5E1] block">Speed Weight</span>
                <span className="text-[#8DC2FF] font-bold">{sliders.speed}%</span>
              </div>
              <div className="bg-[#0E1E38] p-2 rounded-lg border border-white/5">
                <span className="text-[10px] text-[#CBD5E1] block">Safety Weight</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="bg-[#142848] p-3 rounded-xl border border-white/5 space-y-1">
