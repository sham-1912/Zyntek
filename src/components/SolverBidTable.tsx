...
export const SolverBidTable: React.FC<SolverBidTableProps> = ({
  ...
  if (isBroadcasting && bids.length === 0) {
    return (
      <div className="bg-[#0E1E38] border border-[#8DC2FF]/20 rounded-2xl p-8 text-center space-y-4 shadow-xl">
        <div className="w-12 h-12 mx-auto rounded-full bg-[#142848] border border-[#2F6690]/50 flex items-center justify-center">
  ...
  return (
    <div className="bg-[#0E1E38] border border-[#8DC2FF]/20 rounded-2xl p-6 space-y-6 shadow-xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/10 pb-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs px-2.5 py-0.5 rounded-full bg-[#142848] border border-[#CEF26D]/30 text-[#CEF26D] font-mono font-bold">
        ...
        <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#142848] border border-[#8DC2FF]/20 font-mono text-xs text-white shrink-0 self-start sm:self-auto shadow-md">
          ...
          <div className="flex flex-col text-left">
            ...
            <span className={`font-bold font-mono text-sm ${isAuctionClosed ? 'text-[#CEF26D]' : 'text-[#FF7032]'}`}>
              {isAuctionClosed
                ? 'AUCTION CLOSED'
      ...
      {arrivalMessage && !isAuctionClosed && (
        <div className="bg-[#142848] border border-[#8DC2FF]/40 p-3 rounded-xl flex items-center gap-2.5 text-xs text-[#8DC2FF] font-mono animate-in fade-in duration-200">
          ...
          return (
            <motion.div
              ...
              className={`rounded-2xl border transition-all overflow-hidden ${
                isWinner
                  ? 'bg-[#142848] border-[#CEF26D] shadow-xl shadow-[#CEF26D]/15 ring-1 ring-[#CEF26D]'
                  : isRank1
                  ? 'bg-[#142848]/90 border-[#8DC2FF] shadow-lg shadow-[#2F6690]/20'
                  : 'bg-[#0E1E38] hover:bg-[#142848]/60 border-white/10'
              }`}
            >
              {/* Card Main Row */}
              <div className="p-4 sm:p-5 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3.5">
                  <div
                    className={`w-9 h-9 rounded-xl flex items-center justify-center text-xs font-mono font-bold shrink-0 ${
                      isWinner
                        ...
                        : 'bg-[#070F1E] text-[#CBD5E1] border border-white/5'
                    }`}
                  >
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-[#CBD5E1] font-mono mt-0.5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 font-mono text-xs">
                  {/* Expected Output */}
                  <div className="bg-[#070F1E] px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-[10px] text-[#CBD5E1] block">Expected Output</span>
                    <span className="font-bold text-[#CEF26D] text-sm">
                  ...
                  {/* Fee & ETA */}
                  <div className="bg-[#070F1E] px-2.5 py-1.5 rounded-lg border border-white/5">
                    <span className="text-[10px] text-[#CBD5E1] block">Fee / ETA</span>
                  ...
                  <div className="bg-[#070F1E] px-2.5 py-1.5 rounded-lg border border-white/5 col-span-2 sm:col-span-1">
                ...
                <div className="flex items-center justify-between lg:justify-end gap-3 shrink-0 pt-2 lg:pt-0 border-t lg:border-t-0 border-white/5">
                  <div className="text-right">
                    <span className="text-[10px] text-[#CBD5E1] uppercase font-mono block">
                      Score
                    </span>
                    <span
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 rounded-lg bg-[#142848] hover:bg-[#1A335C] border border-[#8DC2FF]/20 text-xs font-mono text-[#8DC2FF] flex items-center gap-1 transition-all cursor-pointer"
                  >
                  ...
                  {onSelectBid && !isAuctionClosed && (
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg bg-[#2F6690] hover:bg-[#3D7BAA] font-mono text-xs font-bold text-white transition-all cursor-pointer"
                    >
                      Select
                    </button>
                  )}
              ...
              {isExpanded && (
                <div className="bg-[#070F1E]/95 border-t border-white/10 p-4 sm:p-5 space-y-3 font-mono text-xs animate-in fade-in duration-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {/* Cost Calculation */}
                    <div className="bg-[#0E1E38] p-3 rounded-xl border border-white/5 space-y-1">
                      ...
                      <div className="text-[11px] text-[#CBD5E1] flex justify-between">
                        <span>User Weight:</span>
                        <span className="text-white">{sliders.cost}%</span>
                      </div>
                      <div className="text-[11px] text-[#CBD5E1] flex justify-between pt-1 border-t border-white/5">
